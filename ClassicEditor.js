...
// import InlineEditor from '@ckeditor/ckeditor5-editor-inline/src/classiceditor';
...
ClassicEditor
    .create( document.querySelector( '#ck-editor' ), {
        plugins: [ Essentials, Paragraph, Bold, Italic, Underline ,Placeholder ],
        toolbar: [ 'bold', 'italic', 'underline', '|', 'placeholder' ],
        placeholderConfig: {
            types: [ 'Anchor', 'Camera', 'Media', 'Other' ]
        }
    } )
    .then( editor => {
